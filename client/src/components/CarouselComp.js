        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption carouselTextArea d-md-block">
              ...
              <p className="randomsText">Dates: {randoms[0] === undefined ? "" : `${randoms[0].StartDate.slice(0, 10).replaceAll("-", "/").split("/").reverse().join("/")}-${randoms[0].EndDate.slice(0, 10).replaceAll("-", "/").split("/").reverse().join("/")}`}</p>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption carouselTextArea d-md-block">
              ...
              <p className="randomsText">Dates: {randoms[0] === undefined ? "" : `${randoms[1].StartDate.slice(0, 10).replaceAll("-", "/").split("/").reverse().join("/")}-${randoms[1].EndDate.slice(0, 10).replaceAll("-", "/").split("/").reverse().join("/")}`}</p>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption carouselTextArea d-md-block ">
              ...
              <p className="randomsText">Dates: {randoms[0] === undefined ? "" : `${randoms[2].StartDate.slice(0, 10).replaceAll("-", "/").split("/").reverse().join("/")}-${randoms[2].EndDate.slice(0, 10).replaceAll("-", "/").split("/").reverse().join("/")}`}</p>
            </div>
          </div>
        </div>
