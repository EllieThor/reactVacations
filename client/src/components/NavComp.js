              ...
              <div className="row">
                <div className="col-4">
                  {props.user === undefined ? (
                    <abbr title="Log In">
                      <i className="fas fa-user-circle fa-2x iconsColor" data-bs-toggle="modal" data-bs-target="#logOrRegisterModal" onClick={() => props.updateContent(1)}></i>
                    </abbr>
                ...
                <div className="col-4">
                  {props.user === undefined ? (
                    <abbr title="Register">
                      <i className="fas fa-user-plus fa-2x iconsColor" data-bs-toggle="modal" data-bs-target="#logOrRegisterModal" onClick={() => props.updateContent(2)}></i>
                    </abbr>
                  ) : (
                    <Link to="/">
                      <abbr title="Log Out">
