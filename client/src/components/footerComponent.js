...
const Footer = () => {
  ...
  return (
    <div className="footer text-center p-3">
      ...
      <a href="https://www.facebook.com/Ellie.kurts/" target="_blank" className="footerIcon">
        <i className="fab fa-facebook px-2 fa-lg"></i>
      </a>
      <a href="https://www.linkedin.com/in/%E2%80%AAellie-thor%E2%80%AC%E2%80%8F-a42195203" target="_blank" className="footerIcon">
      ...
      <a href="https://github.com/EllieThor" target="_blank" className="footerIcon">
